...
from core.models import Alumno, FichaMedica, Cuatrimestre, Carrera, GradoDeEstudio, ContactoEmergencia, SolicitudCredencial, Credencial


class SerializerStudent(ModelSerializer):
