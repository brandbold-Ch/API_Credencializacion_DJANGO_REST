...
from core.models import Directivo, FichaMedica, Credencial, ContactoEmergencia, SolicitudCredencial


class SerializerDirectivo(ModelSerializer):
    ...
    def to_representation(self, instance: Directivo):
